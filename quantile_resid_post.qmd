...
- **Conditional simulations** Commonly, only the last stochastic level (e.g. Poisson) is simulated, conditional on the fitted random effects, basically an omnibus test. 
- **Simulations for other factors** 
Residuals can be simulated for individuals predictors and tests can be conducted for individual factors
-  **Autocorrelation** for any kind of autocorrelation, conditional simulations are a must so that plots don't indicate patterns or the tests fail due to autocorrelation
-  **Ordinal models** randomized quantile residuals do not work with ordinal or multinomial models. 
...
*If you think it's worth keeping, let me know.*
