...
- Fully conditional simulations are recommended for an omnibot us diagnostic; if the model is correct, this should matter, but the conditional simulation is more sensitive.
- We do not know their verall sensitivity to modest model misspecifications.
